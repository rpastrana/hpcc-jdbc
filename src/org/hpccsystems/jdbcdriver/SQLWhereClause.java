...
public class SQLWhereClause
{
    ...
    public void addExpression(SQLExpression expression)
    {
        ...
        if (expression.getExpressionType() == ExpressionType.LOGICAL_EXPRESSION_TYPE)
        {
            ...
            if (expression.getPrefixType() == FragmentType.FIELD_TYPE || expression.getPrefixType() == FragmentType.FIELD_CONTENT_MODIFIER)
            {
            ...
            if (expression.getPostfixType() == FragmentType.FIELD_TYPE || expression.getPostfixType() == FragmentType.FIELD_CONTENT_MODIFIER)
            {
    ...
    public String[] getExpressionColumnNames()
    {
        ...
        for (SQLExpression exp : expressions)
        {
            ...
            {
                if (exp.getPrefixType() == FragmentType.FIELD_TYPE || exp.getPrefixType() == FragmentType.FIELD_CONTENT_MODIFIER)
                    colnames[i++] = exp.getPrefixValue();
                if (exp.getPostfixType() == FragmentType.FIELD_TYPE || exp.getPostfixType() == FragmentType.FIELD_CONTENT_MODIFIER)
